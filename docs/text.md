...
# Lorsque une task est finis et que les test checklist sont valider, donne moi les commandes git add et git commit. 
...
La page /shop/[slug], on dois contacter le commercant depuis le numero de la maison <mervason>
On dois revoir le login, register, recoverpassword... redirection
